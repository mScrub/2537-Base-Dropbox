...
// remote connector
mongoose.connect("mongodb+srv://tickleMeNot:zAEpyfci29Dta1QM@cluster0.tpmee.mongodb.net/FelixsPokemonDatabase?retryWrites=true&w=majority", { useNewUrlParser: true, useUnifiedTopology: true });
// Schema is set.
...
app.get('/api/pokemon/:id', function (req, res) {
    ...
    parameterID = parseInt(req.params.id)
    eventModel.find({
        id: parameterID
    }, function (err, data) {
        if (err) {
